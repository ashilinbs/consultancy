...
import salegif from '../assets/salegif.gif';
import buy_now from '../assets/buy_now.gif';
...
const Home = () => {
  return (
    <div className="bg-gradient-to-br from-blue-50 to-white min-h-screen">
      ...
      <div className="flex items-center justify-between gap-8 p-8 bg-gray-100">
        {/* Left Side (Sale GIF) */}
        <div className="flex-shrink-0">
          <img src={salegif} alt="Sale Gif" className="w-[250px] md:w-[300px] h-auto rounded-xl shadow-lg" />
        </div>
        ...
        <div className="flex-1 max-w-[800px]">
          <motion.div
            ...
            className="mt-10 rounded-3xl overflow-hidden shadow-2xl"
          >
            <Carousel
              autoPlay
              infiniteLoop
        ...
        {/* Right Side (Buy Now GIF) */}
        <div className="flex-shrink-0">
          <img src={buy_now} alt="Buy Now Gif" className="w-[250px] md:w-[300px] h-auto rounded-xl shadow-lg" />
        </div>
      </div>
